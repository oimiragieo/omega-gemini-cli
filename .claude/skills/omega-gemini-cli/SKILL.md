...
Gemini CLI also supports `--output-format stream-json`, `--approval-mode`, `--resume`, and more. See [references/headless.md](references/headless.md) for the full `gemini --help` reference.
