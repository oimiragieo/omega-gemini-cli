...
Add `--model gemini-3.7-flash`, `--sandbox`, or `--json` as needed. Requires Node.js and Gemini CLI to be installed (run **/omega-gemini-setup** in Claude or `node .claude/skills/omega-gemini-cli/scripts/verify-setup.mjs`).
